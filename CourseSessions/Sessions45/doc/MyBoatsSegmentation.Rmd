...
For the segmentation attributes, we chose to use attitudinal data -- specifically we utilized the questions that we felt were representative of the 14 factors that we came up with in Session 2-3. For the profiling attributes, we used all the attitudinal data (Q1, 1-29), as well as the demographic (Q11-15) and behavioral data (Q2-10).
...
We used the Hierarchical Clustering method to identify the segments. Analyzing the Dendogram for the given data, using the euclidean distance metric and the ward hierarchical clustering option, we identified five segments.
...
Based on the data from the responses, we have clustered the subjects who responded into five segments:

<b>Avid Boater</b>
<ul>
  <li>Owns a boat</li>
  <li>Strong supporter of our brand</li>
  <li>Very positive perception of our brand</li>
  <li>Looks for super-spec versions of boats</li>
  <li>Self-declared expert</li>
  <li>Likely to buy a longer boat</li>
</ul>

<b>Price-Conscious Average Joe</b>
<ul>
  <li>Tends to be price sensitive</li>
  <li>Moderately positive perception of our brand</li>
  <li>Boats alone</li>
  <li>More likely to be male</li>
  <li>Looks for high powered boats</li>
  <li>Style seeker</li>
</ul>

<b>Hobbyist</b>
<ul>
  <li>Seeks adventure</li>
  <li>Moderately positive perception of our brand</li>
  <li>Would recommend our boats</li>
  <li>Looks for the frills in a boat</li>
</ul>

<b>Aspirational Buyer</b>
<ul>
  <li>Aspires to own a boat</li>
  <li>Thinks our current boats are difficult to maintain</li>
  <li>Thinks our boats are too expensive</li>
  <li>Likely to buy a boat in the future</li>
  <li>Moderately negative perception of our brand</li>
</ul>

<b>Old Man Sailor</b>
<ul>
  <li>Values the basics</li>
  <li>Not a frequent boater</li>
  <li>Likely older</li>
  <li>Poor perception of our brand</li>
  <li>Likely to buy a shorter boat</li>
</ul>
...
Based on the segments that we recognized above (Avid Boaters, Price-Conscious Average Joes, Hobbyists, Aspirational Buyers, and Old Man Sailors), we can infer which customers our product is servicing well and which customers might have other desires. For example, it seems like Avid Boaters prefer longer, high-specced boats and hold a positive perception of our brand. Meanwhile, Aspirational Buyers perceive our boats as too expensive and too difficult to maintain. Based on this information, we might consider making a more affordable, but simple and reliable boat model. Similarly, we might note that older men (from the Old Man Sailor segment), who also share a poor perception of our boat, prefer shorter, more basic boats for occassional usage. Hence, we might be able to target this segment simultaneously. Based on our interpretation of the data, our primary takeaway is that there seems to be a population of current/prospective boaters for whom our product is unsatisfactory, and that if we want to expand in the North American market, one avenue might be to release a boat that caters to these customers.